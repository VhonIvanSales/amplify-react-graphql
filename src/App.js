...
const App = ({ signOut }) => {
  ...
  //createNote: 
  //This function also uses the API class to send a mutation to the GraphQL API. The main difference is 
  //that in this function we are passing in the variables needed for a GraphQL mutation so that we can 
